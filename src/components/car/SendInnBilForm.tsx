...
const submissionSchema = z.object({
  ...
  car_story: z.string().trim().max(5000, "Om bilen kan ikke være mer enn 5000 tegn").optional().or(z.literal("")),
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4 p-3 sm:p-4 bg-muted/30 rounded-lg border-2 border-muted">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {/* Brand */}
              <FormFieldWithTooltip label="MERKE" tooltip="Bilprodusent, f.eks. Volvo eller Ford" required htmlFor="brand" error={errors.brand}>
